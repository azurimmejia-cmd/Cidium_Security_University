...
**Repositorio:** Cidium_Security_University
...
* **Paso 2 (Clonación):** Usé `git clone` para descargar mi repositorio a mi máquina local.
...
* **Seguridad e Higiene Digital:** Se generó un Personal Access Token (classic) con permisos de `repo`. Además, se cuenta con MFA (Autenticación Multifactor) activado en GitHub mediante TOTP para proteger la cuenta.
